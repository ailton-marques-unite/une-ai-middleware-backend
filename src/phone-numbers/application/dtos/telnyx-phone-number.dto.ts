...
export class CreateTelnyxPhoneNumberDto {
  @ApiProperty({
    description: 'Credential ID for Telnyx provider',
    example: 'credential_telnyx_123'
  })
  @IsString()
  credentialId: string;
  ...
  @ApiProperty({
    ...
    example: 'Telnyx-powered business line',
    required: false
  })
  @IsOptional()
  @IsString()
